...
│   └── schema_v2.sql
├── docs
│   ├── crime-reporting-portal-website-UI
│   │   ├── Admin_pannel.png
│   │   ├── contactus.png
│   │   ├── crime_reporting_system_admin _1.png
│   │   ├── home page.pdf
│   │   ├── login.png
│   │   ├── Register (2).png
│   │   └── registercomplaint.png
│   ├── git-help.md
│   ├── helpme.md
│   ├── project-structure.md
│   └── SQL_QUERY_For_Finding_Near_Police_Station _DISTANCE_README.md
...
│   ├── CrimeGraph.jsx
│   ├── frontend
│   │   ├── Admin_Components_0.0.1
│   │   │   ├── Footer.jsx
│   │   │   ├── Navbar.jsx
│   │   │   └── Sidebar.jsx
│   │   ├── Admin_screen_0.0.1
│   │   │   ├── Dashboard.jsx
│   │   │   ├── -home-pradyumna_52-workspace-Crime-Reporting-Project-Crime-.txt
│   │   │   └── Users.jsx
│   │   └── reports.js
│   ├── login -res-data.json
│   └── PoliceStation.java

...
export default function Globe() {
  ...
  <div className="flex flex-wrap justify-center gap-8">
    ...
    <div className="bg-primary md:h-[400px] md:w-[500px] w-[250px] h-[300px] text-white p-8 rounded-3xl flex flex-col items-center shadow-lg transition-transform transform hover:scale-105">
    ...
    <div className="bg-white w-[250px] h-[300px] md:w-[300px] md:h-[400px] text-gray-900 p-8 rounded-br-3xl shadow-lg w-80 flex flex-col items-center transition-transform transform hover:scale-105">
